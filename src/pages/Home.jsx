...
export default function Home() {
  return (
    <>
      ...
      {/* Membership detail — placeholder for dedicated section */}
      <section id="membership" className="bg-compound-surface py-24 lg:py-32">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          ...
          <p className="font-body text-compound-steel mt-4 max-w-md">
            Flexible tiers giving access to co-working, events, and The Compound community. Full details coming soon.
          </p>
        </div>
      </section>
